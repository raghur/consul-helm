...
@test "serverACLInit/Job: enabled with global.acls.enabled=true" {
  cd `chart_dir`
  local actual=$(helm template \
      -x templates/server-acl-init-job.yaml  \
...
@test "serverACLInit/Job: disabled with server=false and global.acls.enabled=true" {
  cd `chart_dir`
  local actual=$(helm template \
      -x templates/server-acl-init-job.yaml  \
      --set 'global.acls.enabled=true' \
...
@test "serverACLInit/Job: enabled with client=false global.acls.enabled=true" {
  cd `chart_dir`
  local actual=$(helm template \
      -x templates/server-acl-init-job.yaml  \
      --set 'global.acls.enabled=true' \
...
#--------------------------------------------------------------------
# aclBindingRuleSelector/global.acls.enabled
